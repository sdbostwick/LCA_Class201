...
{
    /// <summary>
    /// Concrete class of Truck.  Inherits from base class Automobile, implements IAutomobile interface
    /// </summary>
    public class Truck : Automobile, IAutomobile
    {
        ...
        {
            //base.GetFuel();
            Console.WriteLine("\tDiesel all the way.");
        }

        // Class method
        public void LowerTailgate()
        {
            Console.WriteLine("Tailgate is down.");
        }
    }
}
